...
{
    public partial class ViewEmpIncomeDetails : Form
    {
        public ViewEmpIncomeDetails()
        {
            InitializeComponent();
        }
        ...
        {
            con.Open();
            SqlCommand cmd = new SqlCommand("viewpaymethod", con);
            ...
            da.Fill(dt);
            grdviewempinc.DataSource = dt;
            con.Close();
        }

        private void ViewEmpIncomeDetails_Load(object sender, EventArgs e)
        {
            con.Open();
            SqlCommand cmd = new SqlCommand("viewpaymethod", con);
            cmd.CommandType = CommandType.StoredProcedure;
