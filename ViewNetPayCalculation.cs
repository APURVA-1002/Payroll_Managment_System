...
{
    public partial class ViewNetPayCalculation : Form
    {
        public ViewNetPayCalculation()
        {
            InitializeComponent();
        }
        ...
        {
            con.Open();
            SqlCommand cmd = new SqlCommand("viewsal", con);
            ...
            da.Fill(dt);
            grdviewnetpay.DataSource = dt;
            con.Close();
        }

        private void ViewNetPayCalculation_Load(object sender, EventArgs e)
        {
            con.Open();
            SqlCommand cmd = new SqlCommand("viewsal", con);
            cmd.CommandType = CommandType.StoredProcedure;
