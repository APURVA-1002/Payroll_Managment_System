...
{
    public partial class ViewEarningSection : Form
    {
        public ViewEarningSection()
        {
            InitializeComponent();
        }
        ...
        {
            con.Open();
            SqlCommand cmd = new SqlCommand("viewearn", con);
            ...
            da.Fill(dt);
            grdviewearning.DataSource = dt;
            con.Close();
        }

        private void ViewEarningSection_Load(object sender, EventArgs e)
        {
            con.Open();
            SqlCommand cmd = new SqlCommand("viewearn", con);
            cmd.CommandType = CommandType.StoredProcedure;
